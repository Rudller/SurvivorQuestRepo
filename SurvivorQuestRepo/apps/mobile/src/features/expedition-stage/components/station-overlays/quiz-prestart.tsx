...
> = {
  polish: {
    ...
    descriptionQuiz: "Odpowiedz na pytanie.",
    ...
    miniSudokuEasyDescription: "42 podpowiedzi na planszy, 50% punktów",
    miniSudokuMediumDescription: "36 podpowiedzi na planszy, 100% punktów",
    miniSudokuHardDescription: "28 podpowiedzi na planszy, 150% punktów",
  ...
  english: {
    ...
    miniSudokuEasyDescription: "42 pre-filled cells, 50% points",
    miniSudokuMediumDescription: "36 pre-filled cells, 100% points",
    miniSudokuHardDescription: "28 pre-filled cells, 150% points",
  ...
  ukrainian: {
    ...
    miniSudokuEasyDescription: "42 підказки на полі, 50% балів",
    miniSudokuMediumDescription: "36 підказок на полі, 100% балів",
    miniSudokuHardDescription: "28 підказок на полі, 150% балів",
  ...
  russian: {
    ...
    miniSudokuEasyDescription: "42 подсказки на поле, 50% баллов",
    miniSudokuMediumDescription: "36 подсказок на поле, 100% баллов",
    miniSudokuHardDescription: "28 подсказок на поле, 150% баллов",
