// Copied from apps/mobile/src/features/expedition-stage/components/station-overlays/puzzle-helpers.ts
// so the admin preview generates byte-identical puzzle content to the real mobile app.
...
const MATCHING_FALLBACK_PAIRS: Record<RealizationLanguage, MatchingPair[]> = {
  polish: [
  ...
  other: MATCHING_FALLBACK_PAIRS_ENGLISH,
};
...
export function resolveMatchingPairs(
  station: StationPuzzleViewModel,
  uiLanguage: RealizationLanguage = "polish",
): MatchingPair[] {
