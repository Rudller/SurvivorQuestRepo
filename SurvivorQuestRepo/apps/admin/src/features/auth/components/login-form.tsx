...
export function LoginForm() {
  ...
  return (
    <form
      ...
      className={`sq-form space-y-4 rounded-2xl border border-zinc-700/60 bg-zinc-900/70 p-6 shadow-2xl backdrop-blur transition ${isLeaving ? "login-form-exit" : ""}`}
    >
      <div className="space-y-1.5">
        ...
        <input
          ...
          className="sq-input w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 text-zinc-100 outline-none transition"
        />
      </div>
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative">
          <input
            ...
            className="sq-input w-full rounded-lg border border-zinc-700 bg-zinc-950 px-3 py-2 pr-20 text-zinc-100 outline-none transition"
          />
          <button
            type="button"
      ...
      <button
        type="submit"
        disabled={isLoading || isLoginSuccess}
        className={`sq-button inline-flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2 font-medium transition ${
          isLoginSuccess
